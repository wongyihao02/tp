...
- [Tutorial Commands](#tutorial-commands)
  ...
  - [List existing tutorials: `LIST -t`](#list-existing-tutorials-list--t)
...
- [Task Commands](#task-commands)
  - [Adding a todo: `ADD -pt`](#adding-a-todo-add--pt)
  - [Adding a deadline: `ADD -pd`](#adding-a-deadline-add--pd)
  - [Adding an event: `ADD -pe`](#adding-an-event-add--pe)
  - [Adding a consultation: `ADD -c`](#adding-a-consultation-add--c)
  - [Listing the tasks: `LIST -p`](#listing-the-tasks-list--p)
  - [Deleting a task: `DELETE -p`](#deleting-a-task-delete--p)
  - [Marking a task: `MARK -p`](#marking-a-task-mark--p)
  - [Unmarking a task: `UNMARK -p`](#unmarking-a-task-unmark--p)
  - [Finding a task: `FIND -p`](#finding-a-task-find--p)
  - [Renaming a task: `RENAME -p`](#renaming-a-task-rename--p)
- [AttendanceList Commands](#attendancelist-commands)
  - [View the attendance list: `LIST -a`](#view-the-attendance-list-list--a)
  - [Mark present a student: `MARK -a`](#mark-present-a-student-mark--a)
  - [Mark absent a student: `UNMARK -a`](#mark-absent-a-student-unmark--a)
  - [View comments for a student: `VIEWCOMMENT -a`](#view-comments-for-a-student-viewcomment--a)
  - [Add comments for a student: `COMMENT -a`](#add-comments-for-a-student-comment--a)
  - [delete comments for a student: `DELETECOMMENT -a`](#delete-comment-for-a-student-deletecomment--a)
  - [Create a new attendancelist`CREATE -at`](#create-an-attendance-list-create--at)
